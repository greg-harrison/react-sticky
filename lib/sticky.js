...
var Sticky = (function(_React$Component) {
  ...
  function Sticky(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Sticky.__proto__ || Object.getPrototypeOf(Sticky)).call(this, props)
    )

    _this.updateContext = function(_ref) {
      var inherited = _ref.inherited, node = _ref.node
  ...
  _createClass(Sticky, [
    ...
    },
    {
      ...
      value: function componentDidMount() {
        ...
        this.recomputeState()
        var _this = this
        if (this.props.extObserver && this.props.extObserver.subscribe) {
    ...
    },
    {
      ...
      value: function isSticky() {
        ...
        var bottomBreakpoint =
          this.state.containerOffset + this.props.bottomOffset
    ...
    },
    {
      ...
      value: function shouldComponentUpdate(newProps, newState) {
        ...
        var valuesMatch = propNames.every(function(key) {
          return (
            newProps.hasOwnProperty(key) && newProps[key] === _this2.props[key]
          )
        })
        ...
        if (state.isSticky) {
          ...
          if (newState.distanceFromBottom !== state.distanceFromBottom)
            return true
        }
...
Sticky.propTypes = {
  ...
  extObserver: __propTypes2.default.object,
